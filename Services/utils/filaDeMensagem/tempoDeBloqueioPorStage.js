const TEMPOS_POR_STAGE = {
  ...
  agente_de_identificação_de_nome: 1,
  ...
  agente_de_identificação_de_nome_para_boleto: 2,

  // 🟡 Atendimento para tráfego (médio)
  rotina_captura_de_nome_para_trafego: 2,
  agente_de_identificação_de_nome_para_trafego: 2,

  // 🟠 Demonstração por valor
  rotina_de_demonstracao_de_celular_por_valor: 4,
  filtro_de_valor: 10,
  agente_de_demonstraçao_por_valor: 10,
  identificar_modelo_por_nome_pos_demonstração_por_valor: 3,
  ...
  identificar_modelo_por_nome_pos_demonstração: 4,
  agente_de_demonstração_por_nome: 4,
  agente_de_decisao_pos_demonstracao: 4,

  // 🔴 Demonstração detalhada (mais longas)
  agente_de_demonstração_detalhada: 20,
  agente_de_demonstração_detalhada_boleto: 20,
  ...
  agente_de_demonstração_por_boleto: 6,
