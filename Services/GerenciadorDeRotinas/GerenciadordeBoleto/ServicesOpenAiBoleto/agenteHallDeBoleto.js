...
const agenteHallDeBoleto = async ({ sender, msgContent, pushName }) => {
  ...
  await sendBotMessage(sender, "Toda análise definitiva é feita em loja! Mas se quiser posso fazer um pré-cadastro aqui que temos uma noção de como fica sua aprovação. O que acha? *Me manda seu Nome Completo, CPF, e Data de Nascimento*")
