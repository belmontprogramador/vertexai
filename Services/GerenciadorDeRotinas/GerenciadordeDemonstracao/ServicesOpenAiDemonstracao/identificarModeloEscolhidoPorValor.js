...
const {
  ...
  async function identificarModloEscolhidoPorValor({ sender, msgContent, pushName }) {
    ...
    if (matchesRelevantes.length === 1) {
      ...
      await setUserStage(sender, "agente_de_demonstração_detalhado");
      console.log("devo encaminhar para o agente de demonstração detalhado")
      return await agenteDeDemonstracaoDetalhada({ sender, msgContent, pushName });
    }
  ...
  module.exports = { identificarModloEscolhidoPorValor };
